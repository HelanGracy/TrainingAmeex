<?php
session_start();   if($_SESSION['set'] ==1){
	               $uid=$_SESSION['uid'];
                       $name=$_SESSION['name'];
...
float:left;
  ...
  <script> function onFileSelected(event) {
  ...
  reader.readAsDataURL(selectedFile);
	...
	<div id="main-body">
        ...
        <input type="file" name="img" onchange="onFileSelected(event)"  title="<?php echo $fulltarget;?>">  </div>
