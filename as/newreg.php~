...
</table><a href="index.php">Already registered! Click Here!</a><br><br><br>	</body>
</html>
<?php
...
else
{
	...
	$sql1 = "INSERT INTO ameex_user(name,pass)VALUES('$uname','$pass')";
		...
		$resultt = mysqli_query($cn,$sqll) or die("Error in ameex_avatar Inserting " . mysqli_error($cn));
                          ...
                          {echo "unmatched password"."<br>";  }  //echo "printed user table";
	if($result) 	{
	...
	// "<br><b>Entered data successfully<b>\n";
